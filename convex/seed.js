...
export const seedJohnsPlan = mutation({
  ...
  handler: async (ctx) => {
    ...
    const planStartLocal = new Date(sy, sm - 1, sd);

    function scheduleYmd(dayNumber) {
      const d = new Date(planStartLocal);
    ...
    const phaseData = [
      {
        ...
        startDay: 1,
        endDay: 30,
        milestone: "Complete stakeholder mapping and understand product landscape",
        status: "active",
      },
      {
        number: 2,
        ...
        startDay: 31,
        endDay: 60,
        milestone: "Deliver first research insights and establish credibility",
        status: "upcoming",
      },
      {
        number: 3,
        ...
        startDay: 61,
        endDay: 90,
        milestone: "Own research roadmap and influence product strategy",
        status: "upcoming",
      },
    ];
    ...
    for (const p of phaseData) {
      const id = await ctx.db.insert("phases", {
        planId,
        userId,
        ...p,
      });
    ...
    const activities = [
      ...
      // Week 4 — User & Market Understanding
      ...
      // Week 5 — Quick Wins & First Contributions
      ...
      // Week 12 — Reflection & Next Quarter
    ...
    for (const a of activities) {
      await ctx.db.insert("activities", {
        ...
        priority: a.priority,
        scheduledDate: scheduleYmd(a.day),
        scheduledDay: a.day,
        status: "upcoming",
        isCustom: false,
        source: "seed",
